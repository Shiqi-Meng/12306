...
import org.skyemoon.index12306.biz.orderservice.common.enums.OrderItemStatusEnum;
import org.skyemoon.index12306.biz.orderservice.common.enums.OrderStatusEnum;
...
import org.skyemoon.index12306.biz.orderservice.dao.entity.OrderItemPassengerDO;
import org.skyemoon.index12306.biz.orderservice.dao.mapper.OrderItemMapper;
import org.skyemoon.index12306.biz.orderservice.dao.mapper.OrderItemPassengerMapper;
...
import org.skyemoon.index12306.biz.orderservice.dto.req.*;
...
import org.skyemoon.index12306.biz.orderservice.mq.event.DelayCloseOrderEvent;
import org.skyemoon.index12306.biz.orderservice.mq.event.PayResultCallbackOrderEvent;
import org.skyemoon.index12306.biz.orderservice.mq.produce.DelayCloseOrderSendProduce;
import org.skyemoon.index12306.biz.orderservice.remote.UserRemoteService;
...
import org.skyemoon.index12306.biz.orderservice.service.OrderPassengerRelationService;
import org.skyemoon.index12306.biz.orderservice.service.OrderService;
import org.skyemoon.index12306.biz.orderservice.service.orderid.OrderIdGeneratorManager;
...
import org.skyemoon.index12306.framework.starter.database.toolkit.PageUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResponse<TicketOrderDetailRespDTO> pageTicketOrder(TicketOrderPageQueryReqDTO requestParam) {
        LambdaQueryWrapper<OrderDO> queryWrapper = Wrappers.lambdaQuery(OrderDO.class)
                .eq(OrderDO::getId, requestParam.getUserId())
                .in(OrderDO::getStatus, buildOrderStatusList(requestParam))
                .orderByDesc(OrderDO::getOrderTime);
        Page<OrderDO> orderPage = orderMapper.selectPage(PageUtil.convert(requestParam), queryWrapper);
        return PageUtil.convert(orderPage, each -> {
            ...
            List<OrderItemDO> orderItemDOList = orderItemMapper.selectList(orderItemWrapper);
            result.setPassengerDetails(BeanUtil.convert(orderItemDOList, TicketOrderPassengerDetailRespDTO.class));
            return result;
        });
    }
    ...
    public void payCallbackOrder(PayResultCallbackOrderEvent requestParam) {
        ...
        LambdaQueryWrapper<OrderDO> queryWrapper = Wrappers.lambdaQuery(OrderDO.class)
                .eq(OrderDO::getOrderSn, requestParam.getOrderSn());
        int updateResult = orderMapper.update(updateOrderDO, queryWrapper);
        if (updateResult <= 0) {
            throw new ServiceException(OrderCanalErrorCodeEnum.ORDER_STATUS_REVERSAL_ERROR);
        }
    }
