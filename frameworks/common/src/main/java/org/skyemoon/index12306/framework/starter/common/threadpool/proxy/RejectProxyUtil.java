package org.skyemoon.index12306.framework.starter.common.threadpool.proxy;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import org.skyemoon.index12306.framework.starter.common.toolkit.ThreadUtil;
...
public final class RejectProxyUtil {
    ...
    public static void main(String[] args) {
        ...
        RejectedExecutionHandler proxyRejectedExecutionHandler = RejectProxyUtil.createProxy(abortPolicy, rejectedNum);
