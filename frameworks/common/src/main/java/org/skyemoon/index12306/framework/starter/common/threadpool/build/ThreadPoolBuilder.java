...
public final class ThreadPoolBuilder implements Builder<ThreadPoolExecutor> {
    ...
    public ThreadPoolBuilder threadPoolBuilder(ThreadFactory threadFactory) {
    ...
    public ThreadPoolBuilder threadPoolBuilder(String threadNamePrefix, Boolean isDaemon) {
