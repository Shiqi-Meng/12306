package org.skyemoon.index12306.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(org.skyemoon.index12306.framework.starter.log.annotation.ILog) || @annotation(org.skyemoon.index12306.framework.starter.log.annotation.ILog)")
